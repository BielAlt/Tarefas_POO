 ...
 * @author gabri
 */
@WebServlet(name = "ApiGabrielAltinoServlet", urlPatterns = {"/gabrielaltino.json"})
public class ApiGabrielAltinoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            obj.append("RA", "1290482322019");
            obj.append("Nome", "Gabriel Altino de Oliveira Sousa");
            disciplinas.add("Banco de Dados");
            disciplinas.add("Engenharia de Software III");
            disciplinas.add("Programação Orientada a Objetos");
            disciplinas.add("Linguagem de Programação IV - INTERNET");
